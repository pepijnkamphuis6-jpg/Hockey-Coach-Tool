...
st.set_page_config(
    page_title="Hockey Coach Analyse Tool V7.4",
    layout="wide",
...
def generate_tactical_patterns(df: pd.DataFrame) -> list[str]:
    ...
    for side in [team, opp]:
        ...
        if not entries.empty:
            ...
            if top_pct >= 50:
                patterns.append(f"{top_pct:.0f}% van de cirkelentries van {side} kwam via {str(top_zone).lower()}.")
...
def render_hero_header() -> None:
    ...
    <div class="hero">
        <div class="hero-top">
            <div>
                <div class="hero-title">🏑 Hockey Coach Analyse Tool V7.4</div>
